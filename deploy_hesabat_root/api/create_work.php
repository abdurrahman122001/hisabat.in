...
function recalc_client_balance(mysqli $con, string $client_id, string $date, string $op_id): void
{
    ...
    // Update latest payment row if exists, otherwise insert a summary row (paid=0)
...
try {
    // Deduct stock (if material matches A/B groups)
    ...
    // Recalculate client balance and payment summary based on ALL works
