...
<style>
  ...
  * {
  ...
  body {
    ...
    background: radial-gradient(1200px 600px at 20% 0%, rgba(124, 58, 237, .35), transparent 55%), radial-gradient(900px 520px at 90% 20%, rgba(253, 183, 20, .25), transparent 55%), linear-gradient(180deg, #0b1220 0%, #0f172a 100%);
  }
  ...
  .login-left {
    position: relative;
    padding: 46px 46px;
    background: linear-gradient(135deg, rgba(124, 58, 237, .92) 0%, rgba(99, 102, 241, .88) 35%, rgba(253, 183, 20, .62) 100%);
  }
  ...
  .login-btn {
    ...
    padding: 12px 14px;
    border: none;
    background: linear-gradient(90deg, var(--gri-accent) 0%, #ffd56a 60%, var(--gri-accent) 100%);
    color: #111827;
    font-weight: 900;
    letter-spacing: .3px;
    box-shadow: 0 14px 30px rgba(253, 183, 20, .24);
    cursor: pointer;
  ...
  .login-btn:hover {
    ...
    box-shadow: 0 16px 34px rgba(253, 183, 20, .32);
  }
        ...
        <div class="login-left">
          <div class="login-left-inner">
            ...
            <p class="login-hero-text">
              Hesabat sisteminə daxil olun və işlərin, müştərilərin, ödənişlərin və anbarın idarəsini sürətli şəkildə
              aparın.
            </p>
        ...
        <div class="login-right">
          ...
          <form class="login-form" action="login.php" method="post">
            <div class="login-field">
              ...
              <input type="email" class="login-input" id="exampleInputEmail1" name="email"
                placeholder="məs: nigar@hesabat.in" required>
            </div>

            <div class="login-field">
              <label class="login-label" for="exampleInputPassword1">Şifrə</label>
              <div class="pw-wrap">
                <input type="password" class="login-input with-toggle" id="exampleInputPassword1" name="password"
